      ...
      <div class="hero-grid">
        <div class="hero-content">
          ...
          <p class="hero-description">
            A local RAG chatbot that answers questions using a custom knowledge base,
            retrieves relevant context and shows the sources used to generate each answer.
          </p>
          ...
          <div class="hero-actions">
            ...
            <button class="secondary-button" @click="useExampleQuestion">
          ...
          <div class="features">
            <article>
              ...
              <p>Loads Markdown, TXT, PDF and DOCX files into a vector database.</p>
            </article>

            <article>
              <span>02</span>
              <strong>Local AI model</strong>
              <p>Uses Ollama locally, avoiding external AI API keys for the demo.</p>
            </article>

            <article>
              <span>03</span>
              <strong>Source citations</strong>
              <p>Shows which document chunks were used to generate each answer.</p>
            </article>
          </div>
        </div>
            ...
            <div class="message assistant">
              ...
              <div class="bubble">
                <p>
                  ...
                  For example: <strong>¿Cómo se archiva un usuario?</strong>
                </p>
              </div>
            </div>
                  ...
                  <div v-if="message.showSources" class="source-list">
                    ...
                    >
                      <div class="source-meta">
                        <strong>{{ source.file_name || 'Unknown document' }}</strong>
...
const useExampleQuestion = () => {
  question.value = '¿Cómo se archiva un usuario?';
  focusChatInput();
};
